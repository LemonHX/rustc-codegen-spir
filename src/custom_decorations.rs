...
use std::{borrow::Cow, fmt, iter, marker::PhantomData, ops::Range, path::PathBuf, slice, str};

use either::Either;
use itertools::Itertools;
use rspirv::{
    dr::{Instruction, Module, Operand},
    spirv::{Decoration, Op, Word},
};
use rustc_data_structures::{fx::FxIndexMap, sync::Lrc};
use rustc_span::{source_map::SourceMap, FileName, SourceFile, Span};
use smallvec::SmallVec;

use crate::{
    builder_spirv::BuilderSpirv,
    custom_insts::{self, CustomInst},
};
