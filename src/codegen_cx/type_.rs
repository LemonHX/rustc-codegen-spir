...
use rustc_codegen_ssa::{
    common::TypeKind,
    traits::{BaseTypeMethods, LayoutTypeMethods},
};
use rustc_middle::{
    bug, span_bug,
    ty::{
...
use rustc_target::abi::{
    call::{CastTarget, FnAbi, Reg},
    Abi, AddressSpace, FieldsShape,
};

use super::CodegenCx;
use crate::{abi::ConvSpirvType, spirv_type::SpirvType};
    ...
    fn handle_fn_abi_err(
        ...
        if let FnAbiError::Layout(LayoutError::SizeOverflow(_)) = err {
            self.tcx
                ...
                .psess
                .dcx
                .emit_fatal(Spanned { span, node: err })
        } else {
