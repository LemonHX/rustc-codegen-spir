...
use rspirv::{dr::Operand, spirv::GLOp};
use rustc_codegen_ssa::{
    mir::{operand::OperandRef, place::PlaceRef},
    traits::{BuilderMethods, IntrinsicCallMethods},
};
use rustc_middle::{
    bug,
    ty::{layout::LayoutOf, FnDef, Instance, ParamEnv, Ty, TyKind},
};
