use std::{collections::hash_map::Entry, hash::Hash, iter, slice};

use rustc_data_structures::fx::FxHashMap;
use smallvec::SmallVec;
use spirt::{
    func_at::{FuncAt, FuncAtMut},
    spv,
    transform::InnerInPlaceTransform,
    visit::InnerVisit,
    Const, ConstCtor, ConstDef, Context, ControlNode, ControlNodeDef, ControlNodeKind,
